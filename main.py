...
def get_args(model_name, dataset, custom_key="",losstype='white', yaml_path=None) -> argparse.Namespace:
    ...
    parser.add_argument('--losstype', default=losstype, help='whiten loss')
    parser.add_argument('--fea_ins', type=bool, default=False, help='whiten loss')
    parser.add_argument('--fea', type=bool, default=False, help='whiten loss')
    parser.add_argument('--ins', type=bool, default=False, help='whiten loss')
    parser.add_argument('--diagoff', type=bool, default=True, help='diag loss')
    ...
    with open(yaml_path) as args_file:
        ...
        args_key = "-".join([args.model_name, args.dataset, args.custom_key,args.losstype])
        try:
