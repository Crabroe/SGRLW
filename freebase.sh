...
if [ $num -ge 2363 ];
then
    /home/myj/anaconda3/envs/SuperGAT1.6/bin/python  main_freebase.py --lambd0 ${lam0[i]} --lambd1 ${lam1[j]} --lambd2 ${lam2[k]} --lambd3 ${lam3[l]} --lambd4 ${lam4[o]} --lambd5 ${lam5[p]} --w_loss1 ${w_1[m]} --w_loss2 ${w_2[n]} --w_loss3 ${w_3[q]} --w_loss4 ${w_4[r]} --w_loss5 ${w_5[s]}
fi
    done
    done
    done
